...
<html>
    ...
    <body background="6.jpg">
        <div class="container">
            ...
            %>
            <br /><br />
            <h2 align="center"><font><strong><u>COMMON(CIS & HCL)RECORDS</u></strong></font></h2>
            <table id="example" class="display nowrap" cellspacing="0" width="100%" padding="200px">
                ...
                <tbody>
                    <%    String sql = "SELECT DISTINCT a.KNO,a.BILL_MONTH,a.BILL_YEAR,a.PAYMENT_AMOUNT,a.PAYMENT_DATE,b.RECEIVED_AMOUNT,b.BILL_COLLECTION_DATE FROM CIS_PAYMENT_011116_301116 a,HCL_PAYMENT_011116_301116 b WHERE  a.KNO = b.KNO AND a.PAYMENT_DATE= b.BILL_COLLECTION_DATE AND a.PAYMENT_AMOUNT = b.RECEIVED_AMOUNT";
